...
def read_dataset(path: str) -> Tuple[List, DefaultDict, List]:
...
def partition_data(
    ...
    train_users, train_data, _ = read_dataset(train_path)
    _, test_data, _ = read_dataset(test_path)
    ...
    for user in train_users:
        ...
        if data_type == "femnist":
            ...
            print(f"{data_type} dataset non supportato, che r'è?")
