...
\begin{figure}[htp]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../plots/femnist-horizontal/femnist-share-disjoint-bar.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../plots/femnist-horizontal/femnist-unify-bar.png}
    \end{subfigure}
\end{figure}
...
Concludendo quest'analisi, anche in questo caso si è potuto riscontrare
...
\begin{figure}[htp]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../plots/har-horizontal/har-share-disjoint-bar.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../plots/har-horizontal/har-unify-bar.png}
    \end{subfigure}
\end{figure}
